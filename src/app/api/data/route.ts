...
const DATA_COLUMNS = (p: string) => `
          ...
          round(${p}avg_measured_crossing_speed::numeric, 4)::float AS avg_measured_crossing_speed,
          round(${p}avg_look_before_cross::numeric, 4)::float AS avg_look_before_cross,
          ${p}total_severe_conflicts::int AS total_severe_conflicts,
          round(${p}avg_hesitation_rate::numeric, 4)::float AS avg_hesitation_rate,
